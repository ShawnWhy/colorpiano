...
<body>
    ...
    <div class="all-container">
        ...
        <div class="piano-container" tabindex="1">
            ...
            <div class="key z">
                <div class='keypad'>z</div>
            </div>
            <div class="key x">
                <div class='keypad'>x</div>
            </div>
            <div class="key c">
                <div class='keypad'>c</div>
            </div>
            <div class="key v">
                <div class='keypad'>v</div>
            </div>
            <div class="key b">
                <div class='keypad'>b</div>
            </div>
            <div class="key n">
                <div class='keypad'>n</div>
            </div>
            <div class="key m">
                <div class='keypad'>m</div>
            </div>
